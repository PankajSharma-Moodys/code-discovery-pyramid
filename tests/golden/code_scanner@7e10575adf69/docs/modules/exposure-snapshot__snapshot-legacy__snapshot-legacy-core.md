...
18 tracked files, 992 lines. Part of `tree` at commit `<HEAD>`.

> **This module is not fully covered.** Scopes not completed: `root/exposure-snapshot/snapshot-legacy/snapshot-legacy-core`. Facts about the files in those scopes are missing, not absent.
...
|---|---|---|---|
| `root/exposure-snapshot/snapshot-legacy/snapshot-legacy-core` | 18 | 992 | structural only |
